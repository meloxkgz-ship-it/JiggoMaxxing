...
const RITUALS: Record<Lang, Ritual[]> = {
  en: [
    ...
    },
    {
      id: 'm4',
      context: 'morning',
      title: 'Sun on the skin',
      intention: 'Five minutes of light before any screen is the calmest discipline you can give yourself.',
      steps: [
        'Step outside or to a bright window',
        'Five slow breaths',
        'No phone for these five minutes',
      ],
      duration: '5m',
    },
    {
      id: 'm5',
      context: 'morning',
      title: 'Three lines on paper',
      intention: 'The hand thinks differently than the keyboard. Write before you scroll.',
      steps: [
        'One line: what I want to feel today',
        'One line: who needs my attention',
        'One line: the one thing that has to land',
      ],
      duration: '4m',
    },
    {
      ...
      intention: 'A glass of water is the cheapest decision you will make all day.',
      steps: [
        'Stand up',
        'Full glass, slowly',
        'Notice the temperature',
        'Sit back down at a new angle',
      ],
      duration: '3m',
    },
    {
      ...
      context: 'reset',
      title: 'Shoulder shed',
      intention: 'You are wearing the morning. Take it off.',
      steps: [
        'Roll shoulders back five times',
        'Roll shoulders forward five times',
        'Drop them — just drop them',
      ],
      duration: '1m',
    },
    // ── Evening ──
    ...
    },
    {
      id: 'e4',
      context: 'evening',
      title: 'Read, don\'t scroll',
      intention: 'Twenty pages of anything good is more rest than an hour of feed.',
      steps: [
        'Pick a real book',
        'Phone in another room',
        'Twenty pages, no rush',
      ],
      duration: '15–20m',
    },
    {
      id: 'e5',
      context: 'evening',
      title: 'Skin closing routine',
      intention: 'A short ceremony — not a chore. The body learns rest from the small acts.',
      steps: [
        'Wash with lukewarm water',
        'Toner, two seconds',
        'Moisturiser, then a beat',
        'Retinol only the nights you said you would',
      ],
      duration: '6m',
    },
  ],
  de: [
    ...
    },
    {
      id: 'm4',
      context: 'morning',
      title: 'Sonne auf der Haut',
      intention: 'Fünf Minuten Licht vor jedem Bildschirm sind die ruhigste Disziplin, die du dir geben kannst.',
      steps: [
        'Geh nach draußen oder ans helle Fenster',
        'Fünf langsame Atemzüge',
        'Kein Handy in diesen fünf Minuten',
      ],
      duration: '5 Min',
    },
    {
      id: 'm5',
      context: 'morning',
      title: 'Drei Zeilen auf Papier',
      intention: 'Die Hand denkt anders als die Tastatur. Schreib, bevor du scrollst.',
      steps: [
        'Eine Zeile: was ich heute fühlen will',
        'Eine Zeile: wer meine Aufmerksamkeit braucht',
        'Eine Zeile: die eine Sache, die landen muss',
      ],
      duration: '4 Min',
    },
    {
      id: 'r4',
      context: 'reset',
      title: 'Hydrations-Pause',
      intention: 'Ein Glas Wasser ist die günstigste Entscheidung des Tages.',
      steps: [
        'Steh auf',
        'Ein volles Glas, langsam',
        'Spür die Temperatur',
        'Setz dich in einem neuen Winkel hin',
      ],
      duration: '3 Min',
    },
    {
      id: 'r5',
      context: 'reset',
      title: 'Schultern ablegen',
      intention: 'Du trägst den Morgen. Leg ihn ab.',
      steps: [
        'Schultern fünfmal nach hinten rollen',
        'Schultern fünfmal nach vorne rollen',
    ...
    },
    {
      id: 'e4',
      context: 'evening',
      title: 'Lesen, nicht scrollen',
      intention: 'Zwanzig Seiten von etwas Gutem sind mehr Ruhe als eine Stunde Feed.',
      steps: [
        'Nimm ein echtes Buch',
        'Handy in einen anderen Raum',
        'Zwanzig Seiten, ohne Eile',
      ],
      duration: '15–20 Min',
    },
    {
      ...
      context: 'evening',
      title: 'Skin-Closing-Routine',
      intention: 'Eine kurze Zeremonie — keine Pflicht. Der Körper lernt Ruhe aus kleinen Akten.',
      steps: [
        'Mit lauwarmem Wasser waschen',
        'Toner, zwei Sekunden',
        'Moisturizer, dann ein Atemzug Pause',
        'Retinol nur an den Abenden, die du dir vorgenommen hast',
      ],
      duration: '6 Min',
    },
  ],
